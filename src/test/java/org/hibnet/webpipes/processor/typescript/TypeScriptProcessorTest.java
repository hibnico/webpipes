...
public class TypeScriptProcessorTest extends AbstractProcessorTest {

    private ResourceProcessor processor = new TypeScriptProcessor(resourceFactory);
    ...
    @Test
    public void shouldFailWhenInvalidTypeScriptIsProcessed() throws Exception {
