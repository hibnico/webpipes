/*
 * YUI Compressor http://developer.yahoo.com/yui/compressor/ Author: Julien Lecomte - http://www.julienlecomte.net/ Author: Isaac Schlueter -
 * http://foohack.com/ Author: Stoyan Stefanov - http://phpied.com/ Copyright (c) 2011 Yahoo! Inc. All rights reserved. The copyrights embodied in the
 * content of this file are licensed by Yahoo! Inc. under the BSD (revised) open source license.
 */
...
public class YuiCssCompressor {
    ...
    public void compress(Writer out, int linebreakpos) throws IOException {
        ...
        while (m.find()) {
            ...
            } else if (m.group(3).equalsIgnoreCase(m.group(4)) && m.group(5).equalsIgnoreCase(m.group(6)) && m.group(7).equalsIgnoreCase(m.group(8))) {
                // #AABBCC pattern
